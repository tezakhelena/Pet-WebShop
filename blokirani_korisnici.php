    ...
    if(Admin()){ ?>
        ...
        $(document).ready(function () {
            $('#example').DataTable({
                ...
                "language": {
                    "emptyTable": "Nema blokiranih korisnika",
        ...
        <div class='animate__animated animate__bounceInLeft bar2'>
            <h2><a href='index.php' class='bar'>Početna</a> <span> / <a class='bar' href="svi_korisnici.php"><i class='icon-user'></i> Korisnici</a></span>/ <i class='icon-ban-circle'></i> Blokirani korisnici</span></h2>
            <br></br>
        ...
        $query='SELECT * FROM korisnici WHERE user_status=1';
        $redci = mysqli_query($konekcija, $query);
            ...
            if($redci){
                ...
                <form action="" method="post">
                    <table id="example" class="display" style="width:100%; height: 30%">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            ...
                            while ($row=$redci->fetch_assoc()){ ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php echo"<a href='blokirani_korisnici.php?obrisi=$row[korisnik_id]' onclick=\"javascript: return confirm('Jeste li sigurni da želite obrisati korisnika i sve njegove radnje na stranici?');\" class='btn-delete'><i class='icon-trash'></i> </a>"; ?>
                                    </td>
                                    <td>
