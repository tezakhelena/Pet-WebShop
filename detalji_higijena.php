<?php
    ...
    echo"
        ...
        <div class='animate__animated animate__bounceInLeft bar2'>
            <h2><a href='index.php' class='bar'><i class='icon-home'></i> Početna</a> <span> / </span> <a href='higijena.php' class='bar'> Higijena</a><span> / Detalji</span></h2>
    ";
    ...
    if(isset($_POST['detaljiLjubimca'])){
        ...
        $select = "SELECT * FROM higijena WHERE higijena_id = $_id";
    ...
    $query = "SELECT higijena.*, kategorija.naziv_kategorija FROM higijena INNER JOIN kategorija ON higijena.kategorija_id = kategorija.kategorija_id WHERE higijena.higijena_id = $id";
    ...
    if(mysqli_num_rows($redci) > 0){
                ...
                <div class='detalji'>
                    ...
                    <div class="form">
                        ...
                        <form action="<?php $_SERVER['PHP_SELF'] ?>" method = "post" enctype = "multipart/form-data">
                            ...
                            <?php echo "<h5><b> Dostupnost:</b> " . $row['dostupnost'] . "</p>"; ?>
                            <?php echo "<h5><b> Kategorija:</b> " . $row['naziv_kategorija'] . "</p>"; ?>
        ...
        echo '<div class="alert alert-danger animate__animated animate__backInLeft">Ne postoji proizvod za higijenu sa tim ID-em!</div>';
    }
