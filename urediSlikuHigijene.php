<?php
    $title = "Uređivanje fotografije higijene - Pet Shop"; 
    ...
    <div class='animate__animated animate__bounceInLeft bar2'>
        <h2><a href='index.php' class='bar'><i class='icon-home'></i> Početna</a> <span> / </span> <a href='higijena.php' class='bar'> Higijena</a><span> / <i class='icon-picture'></i> Mjenjanje fotografije</span></h2>
        <br>
    ...
    if(isset($_POST['urediHigijenu'])){
        ...
        if(empty($slika)){
            echo '<div class="alert alert-danger animate__animated animate__backInLeft">Molimo ispunite sva polja</div>';
            ...
            $update = "UPDATE higijena SET slika='$slika' WHERE higijena_id = $higijena_id";
...
<div class="container">
        ...
        <?php
        $query="SELECT*FROM higijena WHERE higijena_id = $higijena_id";
        ...
        <h2 class="trenutna_foto">Trenutna fotografija: </h2></br>
            ...
            <form action="<?php $_SERVER['PHP_SELF'] ?>" method = "post" enctype = "multipart/form-data" class="form_uredi">
                ...
                <input type="submit" class="btn btn-success uredi_slikugumb" name="urediHigijenu" value="Spremi promjene">
                <?php
