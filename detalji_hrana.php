<?php
    ...
    echo"
        ...
        <div class='animate__animated animate__bounceInLeft bar2'>
            <h2><a href='index.php' class='bar'><i class='icon-home'></i> Početna</a> <span> / </span> <a href='hrana.php' class='bar'>Hrana</a><span> / Detalji</span></h2>
    ";
    ...
    if(isset($_POST['detaljiLjubimca'])){
        ...
        $select = "SELECT * FROM hrana WHERE id = $_id";
    ...
    if(mysqli_num_rows($redci) > 0){
            ...
            <div class='detalji'>
                ...
                <div class="form">
                    ...
                    <form action="<?php $_SERVER['PHP_SELF'] ?>" method = "post" enctype = "multipart/form-data">
                        ...
                        <?php echo "<h5> <b>Okus:</b> " . $row['okus'] . "</h5>"; ?>
        ...
        echo '<div class="alert alert-danger animate__animated animate__backInLeft">Ne postoji hrana sa tim ID-em</div>';
    }
