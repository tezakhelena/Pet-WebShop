<?php
    ...
    echo"
        ...
        <div class='animate__animated animate__bounceInLeft bar2'>
            <h2><a href='index.php' class='bar'><i class='icon-home'></i> Početna</a> <span> / </span> <a href='ljubimci.php' class='bar'> Ljubimci</a><span> / Detalji</span></h2>
    ";
    ...
    if(isset($_POST['detaljiLjubimca'])){
        ...
        $select = "SELECT * FROM ljubimci WHERE id = $_id";
    ...
    if(mysqli_num_rows($redci) > 0){
            ...
            <div class='detalji'>
                ...
                <div class="form">
                    ...
                    <form action="<?php $_SERVER['PHP_SELF'] ?>" method = "post" enctype = "multipart/form-data">
                        <?php echo "</br><h1 style='color: blue'><b>" . $row['naziv'] . ", " . $row['ime'] ."</b></h1>"?>
                        <?php echo "<h4 class='sifra'> Šifra proizvoda: " . $id . "</h4>"; ?>
                        <?php echo '<h5><b> Pasmina: </b>' . $row['naziv'] . '</h5>'; ?>
                        <?php echo "<h5><b> Dostupnost:</b> " . $row['dostupnost'] . "</h5>"; ?>
                        <?php echo "<h5><b> Kategorija:</b> " . $row['naziv_kategorija'] . "</h5>"; ?>
                        <?php echo "<h5><b> Starost: </b>" . $row['starost'] . " god</h5>"?>                
                        <?php echo "<h5><b>Cijena: </b>" . $row['cijena'] . " kn</h5></br>"?>
                        <?php
                            echo"
                        ...
                        ?>
                        <hr>
                        <?php echo "<p><b> Opis:</b> " . $row['opis'] . "</p>"; ?>
                        <hr>
                        <?php
        ...
        echo '<div class="alert alert-danger animate__animated animate__backInLeft">Ne postoji ljubimac sa tim ID-em!</div>';
    }
