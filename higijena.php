<?php
    ...
    echo"<link rel='stylesheet' href='https://cdnjs.cloudflare.com/ajax/libs/animate.css/4.0.0/animate.min.css'/>
        ...
        <div class='animate__animated animate__bounceInLeft bar2'>
            <h2><a href='index.php' class='bar'><i class='icon-home'></i> Početna</a> <span> / Higijena</span></h2>
            <br></br>
    ...
    if(isset($_GET['obrisi'])){
        ...
        $query = $konekcija -> prepare('DELETE FROM higijena WHERE higijena_id=?');
...
<div class="container">
        ...
        <ul class="dropdown-menu filter">
            <form action="" method="GET" class="filter">
                <?php
                    ...
                    <a href='higijena.php' class="btn btn-primary refresh_btn">Refresh</a>
                        <?php
                    }
                    else
                    {
    ...
    <?php
if(Admin()){
echo"<a class='btn novododaj animate__animated animate__bounceInLeft' href='dodaj_higijenu.php'><i class='icon-plus'></i><b> Dodaj proizvod</b></a>";
}
echo"<a class='btn osvjezi animate__animated animate__bounceInLeft' href='higijena.php'><i class='icon-refresh'></i><b> Osvježi</b></a>";
            ...
            if(isset($_GET['zivotinje'])){
                ...
                foreach($zivotinjachecked as $rowzivotinja){
                    ...
                    $proizvodi = "SELECT*FROM higijena WHERE kategorija_id IN ($rowzivotinja)";
                                            ...
                                            <form action="" method="post">
                                                <div class="box_proizvod mySlides animate__animated animate__pulse">
                                                    <?php
                                                        ...
                                                        echo"
                                                            <a href='detalji_higijena.php?detalji=$row[higijena_id]' class='za_detalje'>
                                                            ...
                                                            if(Admin()){
                                                                if($row['dostupnost'] != 'Samo u poslovnici'){
                                                                    ...
                                                                    echo"<h5 style='color: red;'>Samo u poslovnici</h5><br></br>";
                                                                }
                                                                echo"
                                                                    <a href='uredi_higijena.php?edit=$row[higijena_id]' class='btn-edit'><i class='icon-edit'></i></a>
                                                                    <a href='urediSlikuHigijene.php?edit=$row[higijena_id]' class='btn-edit2'><i class='icon-picture'></i></a>
                                                                    <a href='higijena.php?obrisi=$row[higijena_id]' onclick=\"javascript: return confirm('Jeste li sigurni da želite izbrisati proizvod?');\" class='btn-delete'><i class='icon-trash'></i> </a>
                                                                ";
                                                            }elseif(User()){
                                                                if($row['dostupnost'] != 'Samo u poslovnici'){
                                                                    echo"<input type='submit' class='btn btn-primary cart' value='U košaricu' name='add_to_cart'><br></br>";
                                                                }else{
                                                                    echo"<h6>Dostupno samo u poslovnici</h6>";
                                                                }
                                                            }else{
                ...
                $query='SELECT * FROM higijena LIMIT ' . $ova_stranica_rezultati . ',' .  $brojRezultataPoStranici;
                $rezultat = mysqli_query($konekcija, $query);
                ?>
                    <section class="proizvod ">
                        <?php if(Admin()){
                            echo"<a class=' btn pdf2 animate__animated animate__bounceInLeft' href='pdf_higijena.php'><i class='icon-print'></i><b> Kreiraj PDF</b></a><br></br>";
                        } ?>
                                                    ...
                                                    echo"
                                                        ...
                                                        if(Admin()){
                                                            ...
                                                            echo"
                                                                <a href='uredi_higijena.php?edit=$row[higijena_id]' class='btn-edit'><i class='icon-edit'></i></a>
                                                                <a href='urediSlikuHigijene.php?edit=$row[higijena_id]' class='btn-edit2'><i class='icon-picture'></i></a>
                                                                <a href='higijena.php?obrisi=$row[higijena_id]' onclick=\"javascript: return confirm('Jeste li sigurni da želite obrisati proizvod za higijenu?');\" class='btn-delete'><i class='icon-trash'></i> </a>
                                                            ";
                                                        }elseif(User()){
                                                            if($row['dostupnost'] != 'Samo u poslovnici'){
                                                                echo"<input type='submit' class='btn btn-primary cart' value='U košaricu' name='add_to_cart'><br></br>";
                ...
                <?php
                    ...
                    if ($brojStranica>1) {
                        ...
                        if($stranica>1) {
                            echo "<li class='page-item'><a class='page-link' href='higijena.php?stranica=" . ($stranica-1) . "'>
                            &laquo Prethodna </a></li>";
                        }
                        for($i=1;$i<=$brojStranica; $i++){
                            if ($i==$stranica) echo "<li class='page-item active'><span class='page-link'> $i </span></li>";
                            else echo "<li class='page-item class='page-link'><a class='page-link' href='higijena.php?stranica=$i'> $i </a></li>";
                        }
