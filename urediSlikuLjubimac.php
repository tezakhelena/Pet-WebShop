<?php
    $title = "Uređivanje fotografije ljubimca - Pet Shop"; 
    ...
    <div class='animate__animated animate__bounceInLeft bar2'>
        <h2><a href='index.php' class='bar'><i class='icon-home'></i> Početna</a> <span> / </span> <a href='ljubimci.php' class='bar'> Ljubimci</a><span> / <i class='icon-picture'></i> Mjenjanje fotografije</span></h2>
        <br>
    ...
    if(isset($_POST['urediLjubimca'])){
        ...
        if(empty($slika)){
            ...
            $update = "UPDATE ljubimci SET slika='$slika' WHERE id = $id";
...
<div class="container">
        ...
        <?php
        $query="SELECT*FROM ljubimci WHERE id = $id";
        ...
        <h2 class="trenutna_foto">Trenutna fotografija: </h2></br>
            ...
            <form action="<?php $_SERVER['PHP_SELF'] ?>" method = "post" enctype = "multipart/form-data" class="form_uredi">
                ...
                <input type="submit" class="btn btn-success uredi_slikugumb" name="urediLjubimca" value="Spremi promjene">
                <?php
