<?php
    ...
    echo"<link rel='stylesheet' href='https://cdnjs.cloudflare.com/ajax/libs/animate.css/4.0.0/animate.min.css'/>
        ...
        <div class='animate__animated animate__bounceInLeft bar2'>
            <h2><a href='index.php' class='bar'><i class='icon-home'></i> Početna</a> <span> / Ljubimci</span></h2>
            <br></br>
    ...
    if(isset($_GET['obrisi'])){
        ...
        $query = $konekcija -> prepare('DELETE FROM ljubimci WHERE id=?');
...
<div class="container">
        ...
        <ul class="dropdown-menu filter">
            <form action="" method="GET" class="filter">
                        <?php
                            ...
                            <a href='ljubimci.php' class="btn btn-primary refresh_btn">Refresh</a>
                                <?php
                            }
                            else
                            {
    ...
    <?php
if(Admin()){
echo"<a class='btn novododaj animate__animated animate__bounceInLeft' href='dodaj_ljubimca.php'><i class='icon-plus'></i><b> Dodaj proizvod</b></a>";
}
echo"<a class='btn osvjezi animate__animated animate__bounceInLeft' href='ljubimci.php'><i class='icon-refresh'></i><b> Osvježi</b></a>";
            ...
            if(isset($_GET['zivotinje'])){
                ...
                foreach($zivotinjachecked as $rowzivotinja){
                    ...
                    $proizvodi = "SELECT*FROM ljubimci WHERE kategorija_id IN ($rowzivotinja)";
                            ...
                            <div class="box-container-filter">
                                ...
                                ?>
                                            <form action="" method="post">
                                                <div class="box_proizvod mySlides animate__animated animate__pulse">
                                                    <?php
                                                        ...
                                                        echo"
                                                            <a href='detalji_ljubimac.php?detalji=$row[id]' class='za_detalje'>
                                                            ...
                                                            if(Admin()){
                                                                ...
                                                                echo"
                                                                    <a href='uredi_ljubimca.php?edit=$row[id]' class='btn-edit'><i class='icon-edit'></i></a>
                                                                    <a href='urediSlikuLjubimac.php?edit=$row[id]' class='btn-edit2'><i class='icon-picture'></i></a>
                                                                    <a href='ljubimci.php?obrisi=$row[id]' onclick=\"javascript: return confirm('Jeste li sigurni da želite izbrisati proizvod?');\" class='btn-delete'><i class='icon-trash'></i> </a>
                                                                ";
                                                            }elseif(User()){
                                                                if($row['dostupnost'] != 'Samo u poslovnici'){
                                                                    echo"<input type='submit' class='btn btn-primary cart' value='U košaricu' name='add_to_cart'><br></br>";
                                    ...
                                    <?php
                                        ...
                                        echo '<div class="alert alert-danger">Nema proizvoda iz odabrane kategorije!</div>';
                                    }                   
                                    ?>
                            </div>
                                </div>
                ...
                $query='SELECT * FROM ljubimci LIMIT ' . $ova_stranica_rezultati . ',' .  $brojRezultataPoStranici;
                $rezultat = mysqli_query($konekcija, $query);
                ?>
                    <section class="proizvod">
                        <?php if(Admin()){
                            echo"<a class=' btn pdf2 animate__animated animate__bounceInLeft' href='pdf_ljubimci.php'><i class='icon-print'></i><b> Kreiraj PDF</b></a>";
                        } ?>
                                        ...
                                        <form action="" method="post">
                                            <div class="box_proizvod animate__animated animate__pulse">
                                                <?php
                                                    ...
                                                    echo"
                                                        <a href='detalji_ljubimac.php?detalji=$row[id]' class='za_detalje'>
                                                            <img class='slika' src='sve_slike/" . $row['slika'] . "' style='width: 200px; border-radius: 5px'/>
                                                            <h4 class='naziv'>" . $row['naziv'] ."</h4>
                                                            <input type='hidden' name='naziv' value=" . $row['naziv'] . ">
                                                            <input type='hidden' name='cijena' value=" . $row['cijena'] . ">
                                                            <input type='hidden' name='slika' value=" . $row['slika'] . ">
                                                        ...
                                                        if(Admin()){
                                                            ...
                                                            echo"
                                                                <a href='uredi_ljubimca.php?edit=$row[id]' class='btn-edit'><i class='icon-edit'></i></a>
                                                                <a href='urediSlikuLjubimac.php?edit=$row[id]' class='btn-edit2'><i class='icon-picture'></i></a>
                                                                <a href='ljubimci.php?obrisi=$row[id]' onclick=\"javascript: return confirm('Jeste li sigurni da želite obrisati ljubimca?');\" class='btn-delete'><i class='icon-trash'></i> </a>
                                                            ";
                                                        }elseif(User()){
                                                            if($row['dostupnost'] != 'Samo u poslovnici'){
                                                                echo"<input type='submit' class='btn btn-primary cart' value='U košaricu' name='add_to_cart'><br></br>";
                ...
                <?php
                    ...
                    if ($brojStranica>1) {
                        ...
                        if($stranica>1) {
                            echo "<li class='page-item'><a class='page-link' href='ljubimci.php?stranica=" . ($stranica-1) . "'>
                            &laquo Prethodna </a></li>";
                        }
                        for($i=1;$i<=$brojStranica; $i++){
                            if ($i==$stranica) echo "<li class='page-item active'><span class='page-link'> $i </span></li>";
                            else echo "<li class='page-item class='page-link'><a class='page-link' href='ljubimci.php?stranica=$i'> $i </a></li>";
                        }
